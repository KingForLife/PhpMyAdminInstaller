...
function output() {
  ...
  printf "\nHosting: https://client.syncnetwork.biz \nDocs: https://docs.syncnetwork.biz \nDiscord Support: https://discord.syncnetwork.biz \nThanks for using the installer! \n\n Save the following:\n\n"
  echo "
  MariaDB-Data:
     IP/Host: localhost
     Port: 3306
...
while getopts ":sh" option; do
  case $option in
    h )
      ...
      echo
      echo "Syntax: bash <(curl -s https://raw.githubusercontent.com/KingForLife/PhpMyAdminInstaller/main/install.sh) [-h|-s]"
      echo
      echo "options:"
...
source <(curl -s https://raw.githubusercontent.com/KingForLife/BashSelect.sh/main/BashSelect.sh)
