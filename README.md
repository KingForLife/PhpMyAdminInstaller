...
```
bash <(curl -s https://raw.githubusercontent.com/KingForLife/PhpMyAdminInstaller/main/install.sh)
```
...
Syntax:
```
bash <(curl -s https://raw.githubusercontent.com/KingForLife/PhpMyAdminInstaller/main/install.sh) [-h|-s]
```
options:
